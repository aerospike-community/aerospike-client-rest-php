...
class ScanOperationsApi
{
     ...
     * @param  bool $concurrent_nodes Should scan requests be issued in parallel. (optional, default to true)
     * @param  bool $fail_on_cluster_change Terminate scan if cluster in migration state. Only used for server versions &lt; 4.9. (optional, default to false)
     * @param  string $from Next page token parameter. (optional, default to null)
     * @param  bool $include_bin_data Should bin data be retrieved. If false, only record digests (and user keys if stored on the server) are retrieved. (optional, default to true)
     ...
     * @param  int $records_per_second Limit returned records per second (rps) rate for each server. Do not apply rps limit if recordsPerSecond is zero. (optional, default to 0)
     ...
     * @param  int $scan_percent Percent of data to scan. Valid integer range is 1 to 100. This field is supported on server versions &lt; 4.9. For server versions &gt;&#x3D; 4.9, use maxRecords. (optional, default to 100)
     ...
     */
    public function performScan($namespace, $set, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
     ...
     */
    public function performScanWithHttpInfo($namespace, $set, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
     ...
     */
    public function performScanAsync($namespace, $set, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function performScanAsyncWithHttpInfo($namespace, $set, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
        $returnType = '\Swagger\Client\Model\RestClientScanResponse';
        $request = $this->performScanRequest($namespace, $set, $authorization, $compress, $concurrent_nodes, $fail_on_cluster_change, $from, $include_bin_data, $keytype, $max_concurrent_nodes, $max_records, $max_retries, $predexp, $read_mode_ap, $read_mode_sc, $record_bins, $records_per_second, $replica, $scan_percent, $send_key, $sleep_between_retries, $socket_timeout, $total_timeout);
     ...
     */
    protected function performScanRequest($namespace, $set, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
     ...
     * @return \Swagger\Client\Model\RestClientScanResponse
     */
    public function performScan1($namespace, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
     ...
     * @return array of \Swagger\Client\Model\RestClientScanResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function performScan1WithHttpInfo($namespace, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
        $returnType = '\Swagger\Client\Model\RestClientScanResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function performScan1Async($namespace, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function performScan1Request($namespace, $authorization = null, $compress = 'false', $concurrent_nodes = 'true', $fail_on_cluster_change = 'false', $from = 'null', $include_bin_data = 'true', $keytype = 'STRING', $max_concurrent_nodes = null, $max_records = null, $max_retries = null, $predexp = 'null', $read_mode_ap = 'ONE', $read_mode_sc = 'SESSION', $record_bins = null, $records_per_second = '0', $replica = 'SEQUENCE', $scan_percent = '100', $send_key = 'false', $sleep_between_retries = null, $socket_timeout = null, $total_timeout = null)
    {
        // verify the required parameter 'namespace' is set
        if ($namespace === null || (is_array($namespace) && count($namespace) === 0)) {
            throw new \InvalidArgumentException(
