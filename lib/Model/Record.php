...
class Record implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['bins'] = $data['bins'] ?? null;
     ...
     * Sets bins
     *
     * @param object|null $bins A mapping from binName to binValue
     *
     * @return self
     */
     ...
     * Sets generation
     *
     * @param int|null $generation The generation of the record.
     *
     * @return self
     */
     ...
     * Sets ttl
     *
     * @param int|null $ttl The time to live for the record, in seconds from now.
     *
     * @return self
     */
